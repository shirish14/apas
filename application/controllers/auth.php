...
class Auth extends CI_Controller {
	...
	function validate() {
		$identity = htmlspecialchars($_POST['identity'], ENT_QUOTES, 'UTF-8');
		$this->session->set_flashdata('identity',$identity);

		if((!$_POST['identity']) || (!$_POST['password'])) {
			if((!$_POST['identity']) && (!$_POST['password'])) {
				$message = 'The Username field is required.<br/>';
			...
			{
				//changes as per ashish requirement
